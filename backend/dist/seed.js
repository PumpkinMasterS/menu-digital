...
async function seed() {
    ...
    try {
        ...
        const burgersCatId = new mongodb_1.ObjectId().toHexString();
        const drinksCatId = new mongodb_1.ObjectId().toHexString();
        const sidesCatId = new mongodb_1.ObjectId().toHexString();
        const dessertsCatId = new mongodb_1.ObjectId().toHexString();
        ...
        const extrasGroupId = new mongodb_1.ObjectId().toHexString();
        await modifiersCol.insertOne({
            ...
            options: [
                { id: new mongodb_1.ObjectId().toHexString(), label: 'Bacon', priceDelta: 1.5, isDefault: false, isAvailable: true },
                { id: new mongodb_1.ObjectId().toHexString(), label: 'Queijo extra', priceDelta: 1.0, isDefault: false, isAvailable: true },
                { id: new mongodb_1.ObjectId().toHexString(), label: 'Ovo', priceDelta: 1.0, isDefault: false, isAvailable: true },
                { id: new mongodb_1.ObjectId().toHexString(), label: 'Cogumelos', priceDelta: 1.5, isDefault: false, isAvailable: true },
            ],
            createdAt: now,
            updatedAt: now,
        });
        console.log('Seeding variant groups...');
        const drinksVariantId = new mongodb_1.ObjectId().toHexString();
        await variantsCol.insertOne({
            ...
            isActive: true,
            options: [
                { id: new mongodb_1.ObjectId().toHexString(), label: 'Pequeno (300ml)', priceDelta: 0, isDefault: true },
                { id: new mongodb_1.ObjectId().toHexString(), label: 'Médio (500ml)', priceDelta: 0.5, isDefault: false },
                { id: new mongodb_1.ObjectId().toHexString(), label: 'Grande (700ml)', priceDelta: 1.0, isDefault: false },
            ],
            createdAt: now,
            updatedAt: now,
        });
